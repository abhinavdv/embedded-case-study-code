...
void Display_Light_Intensity(void)
{
	...
	Light_Intensity[1] = Light%10 + 48;							// Second digit for Light Intensity
	Light_Intensity[0] = Light/10 + 48;							// First digit for Light Intensity
	LCD_Clear();
  LCD_Goto_XY(1, 1);
...
void Welcome_Screen(void)
{
	...
	Delay(1000000);
	LCD_Clear();
	LCD_Send_String("2015-EE-71");
	LCD_Goto_XY(1,2);
	//Delay(1000000);
	LCD_Send_String("2015-EE-73");
	Delay(1000000);
	LCD_Clear();
	LCD_Send_String("2015-EE-74");
	LCD_Goto_XY(1,2);
	//Delay(1000000);
	LCD_Send_String("2015-EE-90");
	Delay(1000000);
	LCD_Clear();
}
